...
contactPoint = {'telephone': '+34 12 34 56 78', 'email': 'example@portauthority.com', 'availableLanguage': ['en-EN', 'es-ES'], 'faxNumber': '12 345 67 89', 'name': 'Port Authoriy name', 'url': 'https://URL'}
