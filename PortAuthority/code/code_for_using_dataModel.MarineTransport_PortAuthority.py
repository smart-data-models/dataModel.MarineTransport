...
contactPoint = {'type': 'Property', 'value': {'telephone': '+34 12 34 56 78', 'email': 'example@port.com', 'availableLanguage': ['en-EN', 'es-ES'], 'faxNumber': '12 345 67 89', 'name': 'Portname', 'url': 'https://URL'}}
