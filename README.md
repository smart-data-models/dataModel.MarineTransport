...
- [Company](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/Company/README.md). This data model describes a company in a port
...
- [NavigationSector](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/NavigationSector/README.md). This data model describes a navigation sector in a port, including geographic boundaries and operational details
...
### Contributors
[Link](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/CONTRIBUTORS.yaml) to the 16 current contributors.
