...
<!-- [code entry](link) -->
[code_for_using_dataModel.MarineTransport_Terminal.py](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/Terminal/code/code_for_using_dataModel.MarineTransport_Terminal.py)
