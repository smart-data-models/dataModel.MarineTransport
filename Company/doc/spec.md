...
<!-- /15-License -->  
<!-- 20-Description -->  
Global description: **This data model describes a company in a port**  
...
- `active[boolean]`: Status of activation of the company or entity with activities or responsibility in the port  - `address[object]`: The mailing address  . Model: [https://schema.org/address](https://schema.org/address)	- `addressCountry[string]`: The country. For example, Spain  . Model: [https://schema.org/addressCountry](https://schema.org/addressCountry)  
...
- `admissionDate[date-string]`: Date in which the company was registered in the model  - `alias[string]`: Non official Name (nickname) of the company or entity with activities or responsibility in the port  - `alternateName[string]`: An alternative name for this item  - `areaServed[string]`: The geographic area where a service or offered item is provided  . Model: [https://schema.org/Text](https://schema.org/Text)- `dataProvider[string]`: A sequence of characters identifying the provider of the harmonised data entity  - `dateCreated[date-time]`: Entity creation timestamp. This will usually be allocated by the storage platform  - `dateModified[date-time]`: Timestamp of the last modification of the entity. This will usually be allocated by the storage platform  - `description[string]`: A description of this item  - `email[idn-email]`: Email address of owner  - `entityType[string]`: Type of the company or entity with activities or responsibility in the port  - `id[*]`: Unique identifier of the entity  - `legalCode[string]`: Code of the company or entity with activities or responsibility in the port  - `licenses[array]`: Licenses of operation of the Company. Usually in pairs, code and description  - `location[*]`: Geojson reference to the item. It can be Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon  - `mrn[string]`: MRN coded identifier. This URN should Conforms MRN & IETF specifically RFC 2141, RFC 5234, and RFC 8141. The proposed format is  id::='urn:mrn:<PORT>:<ONSS>:community:company:id:[0-9]+' or where PORT := UN/LOCODE of port, OID:= Organisation UN/LOCODE, OONSS:=Organization Name of Service, 9999999 an unique identifier that the creator of the company registry entity will identify on his systems (i.e. a SQL row-id), i.e. urn:mrn:eshuv:community:company:id:1296  - `name[string]`: The name of this item  - `owner[array]`: A List containing a JSON encoded sequence of characters referencing the unique Ids of the owner(s)  - `registeredName[string]`: official Name of the company or entity with activities or responsibility in the port  - `seeAlso[*]`: list of uri pointing to additional resources about the item  - `source[string]`: A sequence of characters giving the original source of the entity data as a URL. Recommended to be the fully qualified domain name of the source provider, or the URL to the source object  - `telephone[string]`: Telephone of this contact  - `type[*]`: NGSI Entity type. It has to be Company  <!-- /30-PropertiesList -->  
...
#### Company NGSI-v2 key-values Example    
Here is an example of a Company in JSON format as key-values. This is compatible with NGSI-v2 when  using `options=keyValues` and returns the context data of an individual entity.  
...
#### Company NGSI-v2 normalized Example    
Here is an example of a Company in JSON format as normalized. This is compatible with NGSI-v2 when not using options and returns the context data of an individual entity.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Company NGSI-LD key-values Example    
Here is an example of a Company in JSON-LD format as key-values. This is compatible with NGSI-LD when  using `options=keyValues` and returns the context data of an individual entity.  
<details><summary><strong>show/hide example</strong></summary>    
