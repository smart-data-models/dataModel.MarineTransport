...
<!-- [code entry](link) -->
[code_for_using_dataModel.MarineTransport_Company.py](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/Company/code/code_for_using_dataModel.MarineTransport_Company.py)
