...
class Port(BaseModel):
    ...
    ] = Field(None, description='Reference to the PortAuthority')
    ...
    type: Optional[Type8] = Field(
        None, description='NGSI Entity type. It has to be Port'
    )
