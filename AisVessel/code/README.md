...
<!-- [code entry](link) -->
[code_for_using_dataModel.MarineTransport_AisVessel.py](https://github.com/smart-data-models/dataModel.MarineTransport/blob/master/AisVessel/code/code_for_using_dataModel.MarineTransport_AisVessel.py)
