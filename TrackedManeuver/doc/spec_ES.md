...
<!-- /15-License -->  
<!-- 20-Description -->  
Descripción global: **Entidad TrackedManoeuvre proveniente de Tracked (Sistema de Seguimiento de Operaciones). Maniobra rastreada. El entityId sigue el patrón mrn:urn:eshuv:pdph:Tracked:type:attr:value, donde type=Manoeuvre y attr=manoeuvreCode**  
...
- `alternateName[string]`: Un nombre alternativo para este elemento  - `amendedOnMooringLocation[string]`: Ubicación de la maniobra de 'amarrar junto / modificar en amarre'  - `anchoringAnchorUpDate[date-time]`: Hora de levantar ancla (ancla arriba) para la maniobra de anclaje  - `anchoringDate[date-time]`: Hora de bajar ancla para la maniobra de anclaje  - `anchoringLocation[*]`: Referencia Geojson al elemento. Puede ser Punto, LineString, Polígono, MultiPunto, MultiLineString o MultiPolígono  - `anchoringZone[string]`: Zona de anclaje para la maniobra de anclaje  - `areaServed[string]`: El área geográfica donde se ofrece un servicio o elemento  . Modelo: [https://schema.org/Text](https://schema.org/Text)- `dataProvider[string]`: Una secuencia de caracteres que identifica al proveedor de la entidad de datos armonizados  - `dateCreated[date-time]`: Marca de tiempo de creación de la entidad. Esto suele ser asignado por la plataforma de almacenamiento  - `dateModified[date-time]`: Marca de tiempo de la última modificación de la entidad. Esto suele ser asignado por la plataforma de almacenamiento  - `description[string]`: Una descripción de este elemento  - `durationHours[number]`: Duración de la maniobra en horas  - `endDate[date-time]`: Fecha de finalización de la maniobra  - `id[*]`: Identificador único de la entidad  - `location[*]`: Referencia Geojson al elemento. Puede ser Punto, LineString, Polígono, MultiPunto, MultiLineString o MultiPolígono  - `maneuverCode[string]`: Código de maniobra  - `maneuverType[string]`: Tipo de maniobra  - `mooringCablesNumber[number]`: Número de líneas para la maniobra de amarre  - `mooringChangeCablesNumber[number]`: Número de líneas para la maniobra de cambio de amarre  - `mooringChangeFirstLandCableDate[date-time]`: Hora de la primera línea para la maniobra de cambio de amarre  - `mooringChangeInitialLocation[string]`: Ubicación inicial de la maniobra de cambio de amarre  - `mooringChangeLastCableDate[date-time]`: Hora de la última línea para la maniobra de cambio de amarre  - `mooringChangeLastLocation[string]`: Ubicación final de la maniobra de cambio de amarre  - `mooringChangeNoraysFrom[number]`: Número de bollard desde (maniobra de cambio de amarre)  - `mooringChangeNoraysTo[number]`: Número de bollard hasta (maniobra de cambio de amarre)  - `mooringChangeSide[string]`: Lado de amarre para la maniobra de cambio de amarre  - `mooringFirstCableDate[date-time]`: Hora de la primera línea para la maniobra de amarre  - `mooringLocation[string]`: Ubicación de la maniobra de amarre  - `mooringNoraysFrom[number]`: Número de bollard desde (maniobra de amarre)  - `mooringNoraysTo[number]`: Número de bollard hasta (maniobra de amarre)  - `mooringSide[string]`: Lado de amarre para la maniobra de amarre  - `name[string]`: El nombre de este elemento  - `observations[string]`: Observaciones de la maniobra  - `observedDate[date-time]`: Fecha de última actualización de la entidad  - `othersLocation[*]`: Referencia Geojson al elemento. Puede ser Punto, LineString, Polígono, MultiPunto, MultiLineString o MultiPolígono  - `othersType[string]`: Tipo de otra maniobra  - `othersZone[string]`: Zona/ubicación de la otra maniobra  - `owner[array]`: Una lista que contiene una secuencia de caracteres codificados en JSON que hacen referencia a los identificadores únicos de los propietarios  - `pilotageDisembarkDate[date-time]`: Hora de desembarco del piloto para la maniobra de pilotaje  - `pilotageDisembarkLocation[string]`: Ubicación de desembarco del piloto para la maniobra de pilotaje  - `pilotageEmbarkDate[date-time]`: Hora de embarco del piloto para la maniobra de pilotaje  - `pilotageEmbarkLocation[string]`: Ubicación de embarco del piloto para la maniobra de pilotaje  - `pilotageExempt[string]`: Exención de pilotaje  - `pilotageObservations[string]`: Observaciones de la maniobra de pilotaje  - `pilotagePilots[string]`: Pilotos involucrados en la maniobra de pilotaje  - `portCallCode[string]`: Registro STM de la llamada al puerto  - `refPortCallId[string]`: Referencia a la llamada al puerto  - `refTugServiceId[string]`: Referencia al servicio de remolque  - `seeAlso[*]`: lista de uri que apuntan a recursos adicionales sobre el elemento  - `source[string]`: Una secuencia de caracteres que da la fuente original de los datos de la entidad como una URL. Se recomienda que sea el nombre de dominio completamente calificado del proveedor de la fuente, o la URL del objeto de la fuente  - `startDate[date-time]`: Fecha de inicio de la maniobra  - `tugboatsNumber[number]`: Número de remolcadores para la maniobra de servicio de remolque  - `tugboatsObservations[string]`: Observaciones de la maniobra de servicio de remolque  - `type[string]`: Tipo de entidad NGSI. Debe ser TrackedManoeuvre  - `undockingLastCableDate[date-time]`: Hora de la última línea para la maniobra de desamarre (desanclaje)  - `undockingLocation[string]`: Ubicación de la maniobra de desamarre (desanclaje)  <!-- /30-PropertiesList -->  
...
#### Ejemplo de TrackedManeuver NGSI-v2 clave-valor    
Aquí hay un ejemplo de un TrackedManeuver en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
#### Ejemplo de TrackedManeuver NGSI-v2 normalizado    
Aquí hay un ejemplo de un TrackedManeuver en formato JSON como normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
#### Ejemplo de TrackedManeuver NGSI-LD clave-valor    
Aquí hay un ejemplo de un TrackedManeuver en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
#### Ejemplo de TrackedManeuver NGSI-LD normalizado    
Aquí hay un ejemplo de un TrackedManeuver en formato JSON-LD como normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
