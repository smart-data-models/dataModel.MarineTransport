...
<!-- /15-License -->  
<!-- 20-Description -->  
Global description: **TrackedManoeuvre entity coming from Tracked (Operation Tracking System). Tracked maneuver. The entityId follows the pattern mrn:urn:eshuv:pdph:Tracked:type:attr:value, where type=Manoeuvre and attr=manoeuvreCode**  
...
- `alternateName[string]`: An alternative name for this item  - `amendedOnMooringLocation[string]`: Location of the 'made fast alongside / amended on mooring' maneuver  - `anchoringAnchorUpDate[date-time]`: Anchor aweigh (anchor up) time for the anchoring maneuver  - `anchoringDate[date-time]`: Anchor down time for the anchoring maneuver  - `anchoringLocation[*]`: Geojson reference to the item. It can be Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon  - `anchoringZone[string]`: Anchorage zone for the anchoring maneuver  - `areaServed[string]`: The geographic area where a service or offered item is provided  . Model: [https://schema.org/Text](https://schema.org/Text)- `dataProvider[string]`: A sequence of characters identifying the provider of the harmonised data entity  - `dateCreated[date-time]`: Entity creation timestamp. This will usually be allocated by the storage platform  - `dateModified[date-time]`: Timestamp of the last modification of the entity. This will usually be allocated by the storage platform  - `description[string]`: A description of this item  - `durationHours[number]`: Maneuver duration in hours  - `endDate[date-time]`: Maneuver end date  - `id[*]`: Unique identifier of the entity  - `location[*]`: Geojson reference to the item. It can be Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon  - `maneuverCode[string]`: Maneuver code  - `maneuverType[string]`: Maneuver type  - `mooringCablesNumber[number]`: Number of lines for the mooring maneuver  - `mooringChangeCablesNumber[number]`: Number of lines for the berth-shifting maneuver  - `mooringChangeFirstLandCableDate[date-time]`: First shore line time for the berth-shifting maneuver  - `mooringChangeInitialLocation[string]`: Initial location of the berth-shifting maneuver  - `mooringChangeLastCableDate[date-time]`: Last line time for the berth-shifting maneuver  - `mooringChangeLastLocation[string]`: Final location of the berth-shifting maneuver  - `mooringChangeNoraysFrom[number]`: Bollard number from (berth-shifting maneuver)  - `mooringChangeNoraysTo[number]`: Bollard number to (berth-shifting maneuver)  - `mooringChangeSide[string]`: Mooring side for the berth-shifting maneuver  - `mooringFirstCableDate[date-time]`: First line time for the mooring maneuver  - `mooringLocation[string]`: Location of the mooring maneuver  - `mooringNoraysFrom[number]`: Bollard number from (mooring maneuver)  - `mooringNoraysTo[number]`: Bollard number to (mooring maneuver)  - `mooringSide[string]`: Mooring side for the mooring maneuver  - `name[string]`: The name of this item  - `observations[string]`: Maneuver observations  - `observedDate[date-time]`: Last update date of the entity  - `othersLocation[*]`: Geojson reference to the item. It can be Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon  - `othersType[string]`: Type of other maneuver  - `othersZone[string]`: Zone/location of the other maneuver  - `owner[array]`: A List containing a JSON encoded sequence of characters referencing the unique Ids of the owner(s)  - `pilotageDisembarkDate[date-time]`: Pilot disembarkation time for the pilotage maneuver  - `pilotageDisembarkLocation[string]`: Pilot disembarkation location for the pilotage maneuver  - `pilotageEmbarkDate[date-time]`: Pilot embarkation time for the pilotage maneuver  - `pilotageEmbarkLocation[string]`: Pilot embarkation location for the pilotage maneuver  - `pilotageExempt[string]`: Pilotage exemption  - `pilotageObservations[string]`: Pilotage maneuver observations  - `pilotagePilots[string]`: Pilots involved in the pilotage maneuver  - `portCallCode[string]`: STM register of the port call  - `refPortCallId[string]`: Reference to the port call  - `refTugServiceId[string]`: Reference to the tug service  - `seeAlso[*]`: list of uri pointing to additional resources about the item  - `source[string]`: A sequence of characters giving the original source of the entity data as a URL. Recommended to be the fully qualified domain name of the source provider, or the URL to the source object  - `startDate[date-time]`: Maneuver start date  - `tugboatsNumber[number]`: Number of tugboats for the tug service maneuver  - `tugboatsObservations[string]`: Tug service maneuver observations  - `type[string]`: NGSI Entity type. It has to be TrackedManoeuvre  - `undockingLastCableDate[date-time]`: Last line time for the unmooring (undocking) maneuver  - `undockingLocation[string]`: Location of the unmooring (undocking) maneuver  <!-- /30-PropertiesList -->  
...
#### TrackedManeuver NGSI-v2 key-values Example    
Here is an example of a TrackedManeuver in JSON format as key-values. This is compatible with NGSI-v2 when  using `options=keyValues` and returns the context data of an individual entity.  
...
#### TrackedManeuver NGSI-v2 normalized Example    
Here is an example of a TrackedManeuver in JSON format as normalized. This is compatible with NGSI-v2 when not using options and returns the context data of an individual entity.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### TrackedManeuver NGSI-LD key-values Example    
Here is an example of a TrackedManeuver in JSON-LD format as key-values. This is compatible with NGSI-LD when  using `options=keyValues` and returns the context data of an individual entity.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### TrackedManeuver NGSI-LD normalized Example    
Here is an example of a TrackedManeuver in JSON-LD format as normalized. This is compatible with NGSI-LD when not using options and returns the context data of an individual entity.  
<details><summary><strong>show/hide example</strong></summary>    
